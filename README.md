...
```bash
$ npx nest generate module name_module

$ npx nest generate service name_service
```
...
1. What name would you like to use for this resource (plural, e.g., "users")? your_resource
